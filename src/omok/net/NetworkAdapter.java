...
public class NetworkAdapter {
    ...
    public void writePlay() {
        System.out.println("WE WROTE A PLAY");
    ...
    public void writePlayAck(boolean response, boolean turn) {
        ...
        System.out.println("WE WROTE A PLAY ACK");
    ...
    public void writeMove(int x, int y) {
        System.out.println("WE WROTE A MOVE: x:"+x+" y:"+y);
    ...
    public void writeMoveAck(int x, int y) {
        System.out.println("WE WROTE A MOVE ACK: x:"+x+" y:"+y);
